    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Appelation1", "Rosé", 1, 2002, 2000, "20-1", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(966), 1960 },
                    { 2, "Appelation2", "Bleu", 1, 2002, 2001, "20-2", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1004), 1970 },
                    { 3, "Appelation3", "Verre", 2, 2002, 2001, "20-3", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1008), 1980 },
                    { 4, "Appelation4", "Rouge", 2, 2002, 2000, "20-4", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1011), 1960 },
                    { 5, "Appelation5", "Jaune", 3, 2002, 2000, "20-5", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1014), 1960 },
                    { 6, "Appelation6", "Blanc", 3, 2002, 2000, "20-6", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1017), 1960 },
                    { 7, "Appelation7", "Rouge", 4, 2002, 2000, "20-7", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1020), 1960 },
                    { 8, "Appelation8", "Violet", 4, 2002, 2000, "20-8", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1022), 1960 },
                    { 9, "Appelation9", "Orange", 5, 2002, 2000, "20-9", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1025), 1960 },
                    { 10, "Appelation10", "Violet", 5, 2002, 2000, "20-10", new DateTime(2022, 12, 5, 12, 3, 0, 104, DateTimeKind.Local).AddTicks(1027), 1960 }
                });
